...
source("Helper_Functions_04222025.R")
...
# Customize sample names for figure legends
sample_labels <- list("1" = "UPMC Sample 1", "2" = "UPMC Sample 2")  

################################

# The remaining fields are only needed if running Module 5
...
trend_plots <- plot_target_code_trends(
  ...
  target_code = target_code,
  target_cui = target_cui,
  dictionary_code = filtered_dictionary,
  dictionary_nlp = filtered_dictionary
)
